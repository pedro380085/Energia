...
d.effects.save(q,p),q.show();var m=d.effects.createWrapper(q).css({overflow:"hidden"}),l=n=="vertical"?"height":"width",k=n=="vertical"?m.height():m.width();o=="show"&&m.css(l,0);var b={};b[l]=o=="show"?k:0,m.animate(b,a.duration,a.options.easing,function(){o=="hide"&&q.hide(),d.effects.restore(q,p),d.effects.removeWrapper(q),a.callback&&a.callback.apply(q[0],arguments),q.dequeue()})})}})(jQuery);
/*! jQuery UI - v1.8.21 - 2012-06-05
* https://github.com/jquery/jquery-ui
...
}}setTimeout(function(){a.options.mode=="show"?o.css({visibility:"visible"}):o.css({visibility:"visible"}).hide(),a.callback&&a.callback.apply(o[0]),o.dequeue(),d("div.ui-effects-explode").remove()},a.duration||500)})}})(jQuery);
/*! jQuery UI - v1.8.21 - 2012-06-05
* https://github.com/jquery/jquery-ui
 ...
 * Requires: 1.2.2+
 */
(function(f){function h(a){var o=a||window.event,n=[].slice.call(arguments,1),m=0,l=!0,k=0,j=0;
return a=f.event.fix(o),a.type="mousewheel",o.wheelDelta&&(m=o.wheelDelta/120),o.detail&&(m=-o.detail/3),j=m,o.axis!==undefined&&o.axis===o.HORIZONTAL_AXIS&&(j=0,k=-1*m),o.wheelDeltaY!==undefined&&(j=o.wheelDeltaY/120),o.wheelDeltaX!==undefined&&(k=-1*o.wheelDeltaX/120),n.unshift(a,m,k,j),(f.event.dispatch||f.event.handle).apply(this,n)}var e=["DOMMouseScroll","mousewheel"];if(f.event.fixHooks){for(var i=e.length;i;){f.event.fixHooks[e[--i]]=f.event.mouseHooks}}f.event.special.mousewheel={setup:function(){if(this.addEventListener){for(var b=e.length;b;){this.addEventListener(e[--b],h,!1)}}else{this.onmousewheel=h}},teardown:function(){if(this.removeEventListener){for(var b=e.length;b;){this.removeEventListener(e[--b],h,!1)}}else{this.onmousewheel=null}}},f.fn.extend({mousewheel:function(b){return b?this.bind("mousewheel",b):this.trigger("mousewheel")},unmousewheel:function(b){return this.unbind("mousewheel",b)}})})(jQuery)(function(c){var d={init:function(f){var a={set_width:false,set_height:false,horizontalScroll:false,scrollInertia:550,scrollEasing:"easeOutCirc",mouseWheel:"auto",autoDraggerLength:true,scrollButtons:{enable:false,scrollType:"continuous",scrollSpeed:20,scrollAmount:40},advanced:{updateOnBrowserResize:true,updateOnContentResize:false,autoExpandHorizontalScroll:false},callbacks:{onScroll:function(){},onTotalScroll:function(){},onTotalScrollOffset:0}},f=c.extend(true,a,f);c(document).data("mCS-is-touch-device",false);if(b()){c(document).data("mCS-is-touch-device",true)}function b(){return !!("ontouchstart" in window)?1:0}return this.each(function(){var x=c(this);if(f.set_width){x.css("width",f.set_width)}if(f.set_height){x.css("height",f.set_height)}if(!c(document).data("mCustomScrollbar-index")){c(document).data("mCustomScrollbar-index","1")}else{var F=parseInt(c(document).data("mCustomScrollbar-index"));c(document).data("mCustomScrollbar-index",F+1)}x.wrapInner("<div class='mCustomScrollBox' id='mCSB_"+c(document).data("mCustomScrollbar-index")+"' style='position:relative; height:100%; overflow:hidden; max-width:100%;' />").addClass("mCustomScrollbar _mCS_"+c(document).data("mCustomScrollbar-index"));var D=x.children(".mCustomScrollBox");if(f.horizontalScroll){D.addClass("mCSB_horizontal").wrapInner("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />");var z=D.children(".mCSB_h_wrapper");z.wrapInner("<div class='mCSB_container' style='position:absolute; left:0;' />").children(".mCSB_container").css({width:z.children().outerWidth(),position:"relative"}).unwrap()}else{D.wrapInner("<div class='mCSB_container' style='position:relative; top:0;' />")}var v=D.children(".mCSB_container");if(!c(document).data("mCS-is-touch-device")){v.after("<div class='mCSB_scrollTools' style='position:absolute;'><div class='mCSB_draggerContainer' style='position:relative;'><div class='mCSB_dragger' style='position:absolute;'><div class='mCSB_dragger_bar' style='position:relative;'></div></div><div class='mCSB_draggerRail'></div></div></div>");var y=D.children(".mCSB_scrollTools"),C=y.children(".mCSB_draggerContainer"),t=C.children(".mCSB_dragger");if(f.horizontalScroll){t.data("minDraggerWidth",t.width())}else{t.data("minDraggerHeight",t.height())}if(f.scrollButtons.enable){if(f.horizontalScroll){y.prepend("<a class='mCSB_buttonLeft' style='display:block; position:relative;'></a>").append("<a class='mCSB_buttonRight' style='display:block; position:relative;'></a>")}else{y.prepend("<a class='mCSB_buttonUp' style='display:block; position:relative;'></a>").append("<a class='mCSB_buttonDown' style='display:block; position:relative;'></a>")}}D.bind("scroll",function(){D.scrollTop(0).scrollLeft(0)});x.data({horizontalScroll:f.horizontalScroll,scrollInertia:f.scrollInertia,scrollEasing:f.scrollEasing,mouseWheel:f.mouseWheel,autoDraggerLength:f.autoDraggerLength,"scrollButtons-enable":f.scrollButtons.enable,"scrollButtons-scrollType":f.scrollButtons.scrollType,"scrollButtons-scrollSpeed":f.scrollButtons.scrollSpeed,"scrollButtons-scrollAmount":f.scrollButtons.scrollAmount,autoExpandHorizontalScroll:f.advanced.autoExpandHorizontalScroll,"onScroll-Callback":f.callbacks.onScroll,"onTotalScroll-Callback":f.callbacks.onTotalScroll,"onTotalScroll-Offset":f.callbacks.onTotalScrollOffset}).mCustomScrollbar("update");if(f.advanced.updateOnBrowserResize){var B;c(window).resize(function(){if(B){clearTimeout(B)}B=setTimeout(function(){x.mCustomScrollbar("update")},150)})}}else{var E=navigator.userAgent;if(E.indexOf("Android")!=-1){var e=parseFloat(E.slice(E.indexOf("Android")+8));if(e<3){A("mCSB_"+c(document).data("mCustomScrollbar-index"))}else{D.css({overflow:"auto","-webkit-overflow-scrolling":"touch"})}}else{D.css({overflow:"auto","-webkit-overflow-scrolling":"touch"})}v.addClass("mCS_no_scrollbar mCS_touch");x.data({horizontalScroll:f.horizontalScroll,scrollInertia:f.scrollInertia,scrollEasing:f.scrollEasing,autoExpandHorizontalScroll:f.advanced.autoExpandHorizontalScroll,"onScroll-Callback":f.callbacks.onScroll,"onTotalScroll-Callback":f.callbacks.onTotalScroll,"onTotalScroll-Offset":f.callbacks.onTotalScrollOffset});
D.scroll(function(){x.mCustomScrollbar("callbacks",D,v)});function A(h){var k=document.getElementById(h),j=0,i=0;document.getElementById(h).addEventListener("touchstart",function(l){j=this.scrollTop+l.touches[0].pageY;i=this.scrollLeft+l.touches[0].pageX},false);document.getElementById(h).addEventListener("touchmove",function(l){if((this.scrollTop<this.scrollHeight-this.offsetHeight&&this.scrollTop+l.touches[0].pageY<j-5)||(this.scrollTop!=0&&this.scrollTop+l.touches[0].pageY>j+5)){l.preventDefault()}if((this.scrollLeft<this.scrollWidth-this.offsetWidth&&this.scrollLeft+l.touches[0].pageX<i-5)||(this.scrollLeft!=0&&this.scrollLeft+l.touches[0].pageX>i+5)){l.preventDefault()}this.scrollTop=j-l.touches[0].pageY;this.scrollLeft=i-l.touches[0].pageX},false)}}if(f.advanced.updateOnContentResize){var u;if(f.horizontalScroll){var w=v.outerWidth();if(b()){D.css({"-webkit-overflow-scrolling":"auto"})}}else{var w=v.outerHeight()}u=setInterval(function(){if(f.horizontalScroll){if(f.advanced.autoExpandHorizontalScroll){v.css({position:"absolute",width:"auto"}).wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />").css({width:v.outerWidth(),position:"relative"}).unwrap()}var h=v.outerWidth()}else{var h=v.outerHeight()}if(h!=w){x.mCustomScrollbar("update");w=h}},300)}})},update:function(){var Q=c(this),T=Q.children(".mCustomScrollBox"),N=T.children(".mCSB_container");if(!c(document).data("mCS-is-touch-device")){N.removeClass("mCS_no_scrollbar")}var D=T.children(".mCSB_scrollTools"),P=D.children(".mCSB_draggerContainer"),R=P.children(".mCSB_dragger");if(Q.data("horizontalScroll")){var b=D.children(".mCSB_buttonLeft"),I=D.children(".mCSB_buttonRight"),Y=T.width();if(Q.data("autoExpandHorizontalScroll")){N.css({position:"absolute",width:"auto"}).wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />").css({width:N.outerWidth(),position:"relative"}).unwrap()}var C=N.outerWidth()}else{var F=D.children(".mCSB_buttonUp"),X=D.children(".mCSB_buttonDown"),M=T.height(),V=N.outerHeight()}if(V>M&&!Q.data("horizontalScroll")&&!c(document).data("mCS-is-touch-device")){D.css("display","block");var K=P.height();if(Q.data("autoDraggerLength")){var H=Math.round(M/V*K),S=R.data("minDraggerHeight");if(H<=S){R.css({height:S})}else{if(H>=K-10){var O=K-10;R.css({height:O})}else{R.css({height:H})}}R.children(".mCSB_dragger_bar").css({"line-height":R.height()+"px"})}var a=R.height(),E=(V-M)/(K-a);Q.data("scrollAmount",E);Q.mCustomScrollbar("scrolling",T,N,P,R,F,X,b,I);var J=Math.abs(Math.round(N.position().top));Q.mCustomScrollbar("scrollTo",J,{callback:false})}else{if(C>Y&&Q.data("horizontalScroll")&&!c(document).data("mCS-is-touch-device")){D.css("display","block");var W=P.width();if(Q.data("autoDraggerLength")){var U=Math.round(Y/C*W),L=R.data("minDraggerWidth");if(U<=L){R.css({width:L})}else{if(U>=W-10){var Z=W-10;R.css({width:Z})}else{R.css({width:U})}}}var G=R.width(),E=(C-Y)/(W-G);Q.data("scrollAmount",E);Q.mCustomScrollbar("scrolling",T,N,P,R,F,X,b,I);var J=Math.abs(Math.round(N.position().left));Q.mCustomScrollbar("scrollTo",J,{callback:false})}else{T.unbind("mousewheel");T.unbind("focusin");if(Q.data("horizontalScroll")){R.add(N).css("left",0)}else{R.add(N).css("top",0)}D.css("display","none");N.addClass("mCS_no_scrollbar")}}},scrolling:function(S,K,N,Q,D,X,b,G){var O=c(this);if(!Q.hasClass("ui-draggable")){if(O.data("horizontalScroll")){var R="x"}else{var R="y"}Q.draggable({axis:R,containment:"parent",drag:function(f,e){O.mCustomScrollbar("scroll");Q.addClass("mCSB_dragger_onDrag")},stop:function(f,e){Q.removeClass("mCSB_dragger_onDrag")}})}N.unbind("click").bind("click",function(e){if(O.data("horizontalScroll")){var h=(e.pageX-N.offset().left);if(h<Q.position().left||h>(Q.position().left+Q.width())){var f=h;if(f>=N.width()-Q.width()){f=N.width()-Q.width()}Q.css("left",f);O.mCustomScrollbar("scroll")}}else{var h=(e.pageY-N.offset().top);if(h<Q.position().top||h>(Q.position().top+Q.height())){var f=h;if(f>=N.height()-Q.height()){f=N.height()-Q.height()}Q.css("top",f);O.mCustomScrollbar("scroll")}}});if(O.data("mouseWheel")){var F=O.data("mouseWheel");if(O.data("mouseWheel")==="auto"){F=8;var M=navigator.userAgent;if(M.indexOf("Mac")!=-1&&M.indexOf("Safari")!=-1&&M.indexOf("AppleWebKit")!=-1&&M.indexOf("Chrome")==-1){F=1}}S.unbind("mousewheel").bind("mousewheel",function(n,i){n.preventDefault();var j=Math.abs(i*F);if(O.data("horizontalScroll")){var e=Q.position().left-(i*j);Q.css("left",e);if(Q.position().left<0){Q.css("left",0)}var k=N.width(),l=Q.width();if(Q.position().left>k-l){Q.css("left",k-l)}}else{var h=Q.position().top-(i*j);Q.css("top",h);if(Q.position().top<0){Q.css("top",0)}var m=N.height(),f=Q.height();if(Q.position().top>m-f){Q.css("top",m-f)}}O.mCustomScrollbar("scroll")})}if(O.data("scrollButtons-enable")){if(O.data("scrollButtons-scrollType")==="pixels"){var J;if(c.browser.msie&&parseInt(c.browser.version)<9){O.data("scrollInertia",0)}if(O.data("horizontalScroll")){G.add(b).unbind("click mousedown mouseup mouseout",P,T);
G.bind("click",function(e){e.preventDefault();if(!K.is(":animated")){J=Math.abs(K.position().left)+O.data("scrollButtons-scrollAmount");O.mCustomScrollbar("scrollTo",J)}});b.bind("click",function(e){e.preventDefault();if(!K.is(":animated")){J=Math.abs(K.position().left)-O.data("scrollButtons-scrollAmount");if(K.position().left>=-O.data("scrollButtons-scrollAmount")){J="left"}O.mCustomScrollbar("scrollTo",J)}})}else{X.add(D).unbind("click mousedown mouseup mouseout",H,U);X.bind("click",function(e){e.preventDefault();if(!K.is(":animated")){J=Math.abs(K.position().top)+O.data("scrollButtons-scrollAmount");O.mCustomScrollbar("scrollTo",J)}});D.bind("click",function(e){e.preventDefault();if(!K.is(":animated")){J=Math.abs(K.position().top)-O.data("scrollButtons-scrollAmount");if(K.position().top>=-O.data("scrollButtons-scrollAmount")){J="top"}O.mCustomScrollbar("scrollTo",J)}})}}else{if(O.data("horizontalScroll")){G.add(b).unbind("click mousedown mouseup mouseout",P,T);var B,V=N.width(),E=Q.width();G.bind("mousedown",function(e){e.preventDefault();var f=V-E;B=setInterval(function(){var h=Math.abs(Q.position().left-f)*(100/O.data("scrollButtons-scrollSpeed"));Q.stop().animate({left:f},h,"linear");O.mCustomScrollbar("scroll")},20)});var P=function(e){e.preventDefault();clearInterval(B);Q.stop()};G.bind("mouseup mouseout",P);var W;b.bind("mousedown",function(e){e.preventDefault();var f=0;W=setInterval(function(){var h=Math.abs(Q.position().left-f)*(100/O.data("scrollButtons-scrollSpeed"));Q.stop().animate({left:f},h,"linear");O.mCustomScrollbar("scroll")},20)});var T=function(e){e.preventDefault();clearInterval(W);Q.stop()};b.bind("mouseup mouseout",T)}else{X.add(D).unbind("click mousedown mouseup mouseout",H,U);var L,I=N.height(),a=Q.height();X.bind("mousedown",function(e){e.preventDefault();var f=I-a;L=setInterval(function(){var h=Math.abs(Q.position().top-f)*(100/O.data("scrollButtons-scrollSpeed"));Q.stop().animate({top:f},h,"linear");O.mCustomScrollbar("scroll")},20)});var H=function(e){e.preventDefault();clearInterval(L);Q.stop()};X.bind("mouseup mouseout",H);var C;D.bind("mousedown",function(e){e.preventDefault();var f=0;C=setInterval(function(){var h=Math.abs(Q.position().top-f)*(100/O.data("scrollButtons-scrollSpeed"));Q.stop().animate({top:f},h,"linear");O.mCustomScrollbar("scroll")},20)});var U=function(e){e.preventDefault();clearInterval(C);Q.stop()};D.bind("mouseup mouseout",U)}}}S.unbind("focusin").bind("focusin",function(){S.scrollTop(0).scrollLeft(0);var f=c(document.activeElement);if(f.is("input,textarea,select,button,a[tabindex],area,object")){if(O.data("horizontalScroll")){var j=K.position().left,m=f.position().left,o=S.width(),l=f.outerWidth();if(j+m>=0&&j+m<=o-l){}else{var i=m/O.data("scrollAmount");if(i>=N.width()-Q.width()){i=N.width()-Q.width()}Q.css("left",i);O.mCustomScrollbar("scroll")}}else{var k=K.position().top,n=f.position().top,h=S.height(),e=f.outerHeight();if(k+n>=0&&k+n<=h-e){}else{var i=n/O.data("scrollAmount");if(i>=N.height()-Q.height()){i=N.height()-Q.height()}Q.css("top",i);O.mCustomScrollbar("scroll")}}}})},scroll:function(y){var v=c(this),b=v.find(".mCSB_dragger"),s=v.find(".mCSB_container"),B=v.find(".mCustomScrollBox");if(v.data("horizontalScroll")){var z=b.position().left,t=-z*v.data("scrollAmount"),r=s.position().left,C=Math.round(r-t)}else{var A=b.position().top,w=-A*v.data("scrollAmount"),u=s.position().top,D=Math.round(u-w)}if(c.browser.webkit){var a=(window.outerWidth-8)/window.innerWidth,x=(a<0.98||a>1.02)}if(v.data("scrollInertia")===0||x){if(v.data("horizontalScroll")){s.css("left",t)}else{s.css("top",w)}if(!y){v.mCustomScrollbar("callbacks",B,s)}}else{if(v.data("horizontalScroll")){s.stop().animate({left:"-="+C},v.data("scrollInertia"),v.data("scrollEasing"),function(){if(!y){v.mCustomScrollbar("callbacks",B,s)}})}else{s.stop().animate({top:"-="+D},v.data("scrollInertia"),v.data("scrollEasing"),function(){if(!y){v.mCustomScrollbar("callbacks",B,s)}})}}},scrollTo:function(r,a){var s={moveDragger:false,callback:true},a=c.extend(s,a),p=c(this),v,u=p.find(".mCustomScrollBox"),o=u.children(".mCSB_container");if(!c(document).data("mCS-is-touch-device")){var t=p.find(".mCSB_draggerContainer"),n=t.children(".mCSB_dragger")}var b;if(r){if(typeof(r)==="number"){if(a.moveDragger){v=r}else{b=r;v=Math.round(b/p.data("scrollAmount"))}}else{if(typeof(r)==="string"){var q;if(r==="top"){q=0}else{if(r==="bottom"&&!p.data("horizontalScroll")){q=o.outerHeight()-u.height()}else{if(r==="left"){q=0}else{if(r==="right"&&p.data("horizontalScroll")){q=o.outerWidth()-u.width()}else{if(r==="first"){q=p.find(".mCSB_container").find(":first")}else{if(r==="last"){q=p.find(".mCSB_container").find(":last")}else{q=p.find(r)}}}}}}if(q.length===1){if(p.data("horizontalScroll")){b=q.position().left}else{b=q.position().top}if(c(document).data("mCS-is-touch-device")){v=b}else{v=Math.ceil(b/p.data("scrollAmount"))}}else{v=q}}}if(c(document).data("mCS-is-touch-device")){if(p.data("horizontalScroll")){u.stop().animate({scrollLeft:v},p.data("scrollInertia"),p.data("scrollEasing"),function(){if(a.callback){p.mCustomScrollbar("callbacks",u,o)
}})}else{u.stop().animate({scrollTop:v},p.data("scrollInertia"),p.data("scrollEasing"),function(){if(a.callback){p.mCustomScrollbar("callbacks",u,o)}})}}else{if(p.data("horizontalScroll")){if(v>=t.width()-n.width()){v=t.width()-n.width()}n.css("left",v)}else{if(v>=t.height()-n.height()){v=t.height()-n.height()}n.css("top",v)}if(a.callback){p.mCustomScrollbar("scroll")}else{p.mCustomScrollbar("scroll",true)}}}},callbacks:function(l,b){var a=c(this);if(!c(document).data("mCS-is-touch-device")){if(a.data("horizontalScroll")){var j=Math.round(b.position().left);if(j<0&&j<=l.width()-b.outerWidth()+a.data("onTotalScroll-Offset")){a.data("onTotalScroll-Callback").call()}else{a.data("onScroll-Callback").call()}}else{var k=Math.round(b.position().top);if(k<0&&k<=l.height()-b.outerHeight()+a.data("onTotalScroll-Offset")){a.data("onTotalScroll-Callback").call()}else{a.data("onScroll-Callback").call()}}}else{if(a.data("horizontalScroll")){var m=Math.round(l.scrollLeft());if(m>0&&m>=b.outerWidth()-a.width()-a.data("onTotalScroll-Offset")){a.data("onTotalScroll-Callback").call()}else{a.data("onScroll-Callback").call()}}else{var n=Math.round(l.scrollTop());if(n>0&&n>=b.outerHeight()-a.height()-a.data("onTotalScroll-Offset")){a.data("onTotalScroll-Callback").call()}else{a.data("onScroll-Callback").call()}}}}};c.fn.mCustomScrollbar=function(a){if(d[a]){return d[a].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof a==="object"||!a){return d.init.apply(this,arguments)}else{c.error("Method "+a+" does not exist")}}}})(jQuery);var qq=qq||{};qq.extend=function(d,e){for(var f in e){d[f]=e[f]}};qq.indexOf=function(e,i,h){if(e.indexOf){return e.indexOf(i,h)}h=h||0;var f=e.length;if(h<0){h+=f}for(;h<f;h++){if(h in e&&e[h]===i){return h}}return -1};qq.getUniqueId=(function(){var b=0;return function(){return b++}})();qq.attach=function(e,f,d){if(e.addEventListener){e.addEventListener(f,d,false)}else{if(e.attachEvent){e.attachEvent("on"+f,d)}}};qq.detach=function(e,f,d){if(e.removeEventListener){e.removeEventListener(f,d,false)}else{if(e.attachEvent){e.detachEvent("on"+f,d)}}};qq.preventDefault=function(b){if(b.preventDefault){b.preventDefault()}else{b.returnValue=false}};qq.insertBefore=function(a,b){b.parentNode.insertBefore(a,b)};qq.remove=function(b){b.parentNode.removeChild(b)};qq.contains=function(c,d){if(c==d){return true}if(c.contains){return c.contains(d)}else{return !!(d.compareDocumentPosition(c)&8)}};qq.toElement=(function(){var b=document.createElement("div");return function(d){b.innerHTML=d;var a=b.firstChild;b.removeChild(a);return a}})();qq.css=function(d,c){if(c.opacity!=null){if(typeof d.style.opacity!="string"&&typeof(d.filters)!="undefined"){c.filter="alpha(opacity="+Math.round(100*c.opacity)+")"}}qq.extend(d.style,c)};qq.hasClass=function(d,e){var f=new RegExp("(^| )"+e+"( |$)");return f.test(d.className)};qq.addClass=function(c,d){if(!qq.hasClass(c,d)){c.className+=" "+d}};qq.removeClass=function(d,e){var f=new RegExp("(^| )"+e+"( |$)");d.className=d.className.replace(f," ").replace(/^\s+|\s+$/g,"")};qq.setText=function(d,c){d.innerText=c;d.textContent=c};qq.children=function(d){var e=[],f=d.firstChild;while(f){if(f.nodeType==1){e.push(f)}f=f.nextSibling}return e};qq.getByClass=function(l,k){if(l.querySelectorAll){return l.querySelectorAll("."+k)}var h=[];var j=l.getElementsByTagName("*");var i=j.length;for(var m=0;m<i;m++){if(qq.hasClass(j[m],k)){h.push(j[m])}}return h};qq.obj2url=function(m,i,k){var l=[],o="&",n=function(b,c){var a=i?(/\[\]$/.test(i))?i:i+"["+c+"]":c;if((a!="undefined")&&(c!="undefined")){l.push((typeof b==="object")?qq.obj2url(b,a,true):(Object.prototype.toString.call(b)==="[object Function]")?encodeURIComponent(a)+"="+encodeURIComponent(b()):encodeURIComponent(a)+"="+encodeURIComponent(b))}};if(!k&&i){o=(/\?/.test(i))?(/\?$/.test(i))?"":"&":"?";l.push(i);l.push(qq.obj2url(m))}else{if((Object.prototype.toString.call(m)==="[object Array]")&&(typeof m!="undefined")){for(var p=0,j=m.length;p<j;++p){n(m[p],p)}}else{if((typeof m!="undefined")&&(m!==null)&&(typeof m==="object")){for(var p in m){n(m[p],p)}}else{l.push(encodeURIComponent(i)+"="+encodeURIComponent(m))}}}return l.join(o).replace(/^&/,"").replace(/%20/g,"+")};var qq=qq||{};qq.FileUploaderBasic=function(b){this._options={debug:false,action:"/server/upload",params:{},button:null,multiple:true,maxConnections:3,allowedExtensions:[],sizeLimit:0,minSizeLimit:0,onSubmit:function(d,a){},onProgress:function(f,h,a,i){},onComplete:function(e,f,a){},onCancel:function(d,a){},messages:{typeError:"{file} has invalid extension. Only {extensions} are allowed.",sizeError:"{file} is too large, maximum file size is {sizeLimit}.",minSizeError:"{file} is too small, minimum file size is {minSizeLimit}.",emptyError:"{file} is empty, please select files again without it.",onLeave:"The files are being uploaded, if you leave now the upload will be cancelled."},showMessage:function(a){alert(a)}};qq.extend(this._options,b);this._filesInProgress=0;this._handler=this._createUploadHandler();
if(this._options.button){this._button=this._createUploadButton(this._options.button)}this._preventLeaveInProgress()};qq.FileUploaderBasic.prototype={setParams:function(b){this._options.params=b},getInProgress:function(){return this._filesInProgress},_createUploadButton:function(c){var d=this;return new qq.UploadButton({element:c,multiple:this._options.multiple&&qq.UploadHandlerXhr.isSupported(),onChange:function(a){d._onInputChange(a)}})},_createUploadHandler:function(){var e=this,f;if(qq.UploadHandlerXhr.isSupported()){f="UploadHandlerXhr"}else{f="UploadHandlerForm"}var d=new qq[f]({debug:this._options.debug,action:this._options.action,maxConnections:this._options.maxConnections,onProgress:function(a,b,h,c){e._onProgress(a,b,h,c);e._options.onProgress(a,b,h,c)},onComplete:function(a,b,c){e._onComplete(a,b,c);e._options.onComplete(a,b,c)},onCancel:function(a,b){e._onCancel(a,b);e._options.onCancel(a,b)}});return d},_preventLeaveInProgress:function(){var b=this;qq.attach(window,"beforeunload",function(a){if(!b._filesInProgress){return}var a=a||window.event;a.returnValue=b._options.messages.onLeave;return b._options.messages.onLeave})},_onSubmit:function(c,d){this._filesInProgress++},_onProgress:function(h,i,f,e){},_onComplete:function(f,d,e){this._filesInProgress--;if(e.error){this._options.showMessage(e.error)}},_onCancel:function(c,d){this._filesInProgress--},_onInputChange:function(b){if(this._handler instanceof qq.UploadHandlerXhr){this._uploadFileList(b.files)}else{if(this._validateFile(b)){this._uploadFile(b)}}this._button.reset()},_uploadFileList:function(c){for(var d=0;d<c.length;d++){if(!this._validateFile(c[d])){return}}for(var d=0;d<c.length;d++){this._uploadFile(c[d])}},_uploadFile:function(e){var f=this._handler.add(e);var d=this._handler.getName(f);if(this._options.onSubmit(f,d)!==false){this._onSubmit(f,d);this._handler.upload(f,this._options.params)}},_validateFile:function(f){var e,d;if(f.value){e=f.value.replace(/.*(\/|\\)/,"")}else{e=f.fileName!=null?f.fileName:f.name;d=f.fileSize!=null?f.fileSize:f.size}if(!this._isAllowedExtension(e)){this._error("typeError",e);return false}else{if(d===0){this._error("emptyError",e);return false}else{if(d&&this._options.sizeLimit&&d>this._options.sizeLimit){this._error("sizeError",e);return false}else{if(d&&d<this._options.minSizeLimit){this._error("minSizeError",e);return false}}}}return true},_error:function(i,h){var e=this._options.messages[i];function f(b,a){e=e.replace(b,a)}f("{file}",this._formatFileName(h));f("{extensions}",this._options.allowedExtensions.join(", "));f("{sizeLimit}",this._formatSize(this._options.sizeLimit));f("{minSizeLimit}",this._formatSize(this._options.minSizeLimit));this._options.showMessage(e)},_formatFileName:function(b){if(b.length>33){b=b.slice(0,19)+"..."+b.slice(-13)}return b},_isAllowedExtension:function(h){var e=(-1!==h.indexOf("."))?h.replace(/.*[.]/,"").toLowerCase():"";var i=this._options.allowedExtensions;if(!i.length){return true}for(var f=0;f<i.length;f++){if(i[f].toLowerCase()==e){return true}}return false},_formatSize:function(d){var c=-1;do{d=d/1024;c++}while(d>99);return Math.max(d,0.1).toFixed(1)+["kB","MB","GB","TB","PB","EB"][c]}};qq.FileUploader=function(b){qq.FileUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,template:'<div class="qq-uploader"><div class="qq-upload-drop-area"><span>Drop files here to upload</span></div><div class="qq-upload-button">Escolher uma imagem</div><ul class="qq-upload-list"></ul></div>',fileTemplate:'<li><span class="qq-upload-file"></span><span class="qq-upload-spinner"></span><span class="qq-upload-size"></span><a class="qq-upload-cancel" href="#">Cancel</a><span class="qq-upload-failed-text">Failed</span></li>',classes:{button:"qq-upload-button",drop:"qq-upload-drop-area",dropActive:"qq-upload-drop-area-active",list:"qq-upload-list",file:"qq-upload-file",spinner:"qq-upload-spinner",size:"qq-upload-size",cancel:"qq-upload-cancel",success:"qq-upload-success",fail:"qq-upload-fail"}});qq.extend(this._options,b);this._element=this._options.element;this._element.innerHTML=this._options.template;this._listElement=this._options.listElement||this._find(this._element,"list");this._classes=this._options.classes;this._button=this._createUploadButton(this._find(this._element,"button"));this._bindCancelEvent();this._setupDragDrop()};qq.extend(qq.FileUploader.prototype,qq.FileUploaderBasic.prototype);qq.extend(qq.FileUploader.prototype,{_find:function(f,d){var e=qq.getByClass(f,this._options.classes[d])[0];if(!e){throw new Error("element not found "+d)}return e},_setupDragDrop:function(){var d=this,f=this._find(this._element,"drop");var e=new qq.UploadDropZone({element:f,onEnter:function(a){qq.addClass(f,d._classes.dropActive);a.stopPropagation()},onLeave:function(a){a.stopPropagation()},onLeaveNotDescendants:function(a){qq.removeClass(f,d._classes.dropActive)},onDrop:function(a){f.style.display="none";qq.removeClass(f,d._classes.dropActive);d._uploadFileList(a.dataTransfer.files)
}});f.style.display="none";qq.attach(document,"dragenter",function(a){if(!e._isValidFileDrag(a)){return}f.style.display="block"});qq.attach(document,"dragleave",function(a){if(!e._isValidFileDrag(a)){return}var b=document.elementFromPoint(a.clientX,a.clientY);if(!b||b.nodeName=="HTML"){f.style.display="none"}})},_onSubmit:function(c,d){qq.FileUploaderBasic.prototype._onSubmit.apply(this,arguments);this._addToList(c,d)},_onProgress:function(j,k,i,m){qq.FileUploaderBasic.prototype._onProgress.apply(this,arguments);var n=this._getItemByFileId(j);var h=this._find(n,"size");h.style.display="inline";var l;if(i!=m){l=Math.round(i/m*100)+"% from "+this._formatSize(m)}else{l=this._formatSize(m)}qq.setText(h,l)},_onComplete:function(h,i,f){qq.FileUploaderBasic.prototype._onComplete.apply(this,arguments);var e=this._getItemByFileId(h);qq.remove(this._find(e,"cancel"));qq.remove(this._find(e,"spinner"));if(f.success){qq.addClass(e,this._classes.success)}else{qq.addClass(e,this._classes.fail)}},_addToList:function(h,i){var f=qq.toElement(this._options.fileTemplate);f.qqFileId=h;var e=this._find(f,"file");qq.setText(e,this._formatFileName(i));this._find(f,"size").style.display="none";this._listElement.appendChild(f)},_getItemByFileId:function(c){var d=this._listElement.firstChild;while(d){if(d.qqFileId==c){return d}d=d.nextSibling}},_bindCancelEvent:function(){var d=this,c=this._listElement;qq.attach(c,"click",function(a){a=a||window.event;var b=a.target||a.srcElement;if(qq.hasClass(b,d._classes.cancel)){qq.preventDefault(a);var e=b.parentNode;d._handler.cancel(e.qqFileId);qq.remove(e)}})}});qq.UploadDropZone=function(b){this._options={element:null,onEnter:function(a){},onLeave:function(a){},onLeaveNotDescendants:function(a){},onDrop:function(a){}};qq.extend(this._options,b);this._element=this._options.element;this._disableDropOutside();this._attachEvents()};qq.UploadDropZone.prototype={_disableDropOutside:function(b){if(!qq.UploadDropZone.dropOutsideDisabled){qq.attach(document,"dragover",function(a){if(a.dataTransfer){a.dataTransfer.dropEffect="none";a.preventDefault()}});qq.UploadDropZone.dropOutsideDisabled=true}},_attachEvents:function(){var b=this;qq.attach(b._element,"dragover",function(d){if(!b._isValidFileDrag(d)){return}var a=d.dataTransfer.effectAllowed;if(a=="move"||a=="linkMove"){d.dataTransfer.dropEffect="move"}else{d.dataTransfer.dropEffect="copy"}d.stopPropagation();d.preventDefault()});qq.attach(b._element,"dragenter",function(a){if(!b._isValidFileDrag(a)){return}b._options.onEnter(a)});qq.attach(b._element,"dragleave",function(d){if(!b._isValidFileDrag(d)){return}b._options.onLeave(d);var a=document.elementFromPoint(d.clientX,d.clientY);if(qq.contains(this,a)){return}b._options.onLeaveNotDescendants(d)});qq.attach(b._element,"drop",function(a){if(!b._isValidFileDrag(a)){return}a.preventDefault();b._options.onDrop(a)})},_isValidFileDrag:function(f){var d=f.dataTransfer,e=navigator.userAgent.indexOf("AppleWebKit")>-1;return d&&d.effectAllowed!="none"&&(d.files||(!e&&d.types.contains&&d.types.contains("Files")))}};qq.UploadButton=function(b){this._options={element:null,multiple:false,name:"file",onChange:function(a){},hoverClass:"qq-upload-button-hover",focusClass:"qq-upload-button-focus"};qq.extend(this._options,b);this._element=this._options.element;qq.css(this._element,{position:"relative",overflow:"hidden",direction:"ltr"});this._input=this._createInput()};qq.UploadButton.prototype={getInput:function(){return this._input},reset:function(){if(this._input.parentNode){qq.remove(this._input)}qq.removeClass(this._element,this._options.focusClass);this._input=this._createInput()},_createInput:function(){var c=document.createElement("input");if(this._options.multiple){c.setAttribute("multiple","multiple")}c.setAttribute("type","file");c.setAttribute("name",this._options.name);qq.css(c,{position:"absolute",right:0,top:0,fontFamily:"Arial",fontSize:"118px",margin:0,padding:0,cursor:"pointer",opacity:0});this._element.appendChild(c);var d=this;qq.attach(c,"change",function(){d._options.onChange(c)});qq.attach(c,"mouseover",function(){qq.addClass(d._element,d._options.hoverClass)});qq.attach(c,"mouseout",function(){qq.removeClass(d._element,d._options.hoverClass)});qq.attach(c,"focus",function(){qq.addClass(d._element,d._options.focusClass)});qq.attach(c,"blur",function(){qq.removeClass(d._element,d._options.focusClass)});if(window.attachEvent){c.setAttribute("tabIndex","-1")}return c}};qq.UploadHandlerAbstract=function(b){this._options={debug:false,action:"/upload.php",maxConnections:999,onProgress:function(f,h,a,i){},onComplete:function(e,f,a){},onCancel:function(d,a){}};qq.extend(this._options,b);this._queue=[];this._params=[]};qq.UploadHandlerAbstract.prototype={log:function(b){if(this._options.debug&&window.console){console.log("[uploader] "+b)}},add:function(b){},upload:function(h,e){var f=this._queue.push(h);var i={};qq.extend(i,e);this._params[h]=i;if(f<=this._options.maxConnections){this._upload(h,this._params[h])
}},cancel:function(b){this._cancel(b);this._dequeue(b)},cancelAll:function(){for(var b=0;b<this._queue.length;b++){this._cancel(this._queue[b])}this._queue=[]},getName:function(b){},getSize:function(b){},getQueue:function(){return this._queue},_upload:function(b){},_cancel:function(b){},_dequeue:function(h){var e=qq.indexOf(this._queue,h);this._queue.splice(e,1);var f=this._options.maxConnections;if(this._queue.length>=f&&e<f){var i=this._queue[f-1];this._upload(i,this._params[i])}}};qq.UploadHandlerForm=function(b){qq.UploadHandlerAbstract.apply(this,arguments);this._inputs={}};qq.extend(qq.UploadHandlerForm.prototype,qq.UploadHandlerAbstract.prototype);qq.extend(qq.UploadHandlerForm.prototype,{add:function(d){d.setAttribute("name","qqfile");var c="qq-upload-handler-iframe"+qq.getUniqueId();this._inputs[c]=d;if(d.parentNode){qq.remove(d)}return c},getName:function(b){return this._inputs[b].value.replace(/.*(\/|\\)/,"")},_cancel:function(c){this._options.onCancel(c,this.getName(c));delete this._inputs[c];var d=document.getElementById(c);if(d){d.setAttribute("src","javascript:false;");qq.remove(d)}},_upload:function(j,l){var h=this._inputs[j];if(!h){throw new Error("file with passed id was not added, or already uploaded or cancelled")}var k=this.getName(j);var n=this._createIframe(j);var m=this._createForm(n,l);m.appendChild(h);var i=this;this._attachLoadEvent(n,function(){i.log("iframe loaded");var a=i._getIframeContentJSON(n);i._options.onComplete(j,k,a);i._dequeue(j);delete i._inputs[j];setTimeout(function(){qq.remove(n)},1)});m.submit();qq.remove(m);return j},_attachLoadEvent:function(d,c){qq.attach(d,"load",function(){if(!d.parentNode){return}if(d.contentDocument&&d.contentDocument.body&&d.contentDocument.body.innerHTML=="false"){return}c()})},_getIframeContentJSON:function(iframe){var doc=iframe.contentDocument?iframe.contentDocument:iframe.contentWindow.document,response;this.log("converting iframe's innerHTML to JSON");this.log("innerHTML = "+doc.body.innerHTML);try{response=eval("("+doc.body.innerHTML+")")}catch(err){response={}}return response},_createIframe:function(c){var d=qq.toElement('<iframe src="javascript:false;" name="'+c+'" />');d.setAttribute("id",c);d.style.display="none";document.body.appendChild(d);return d},_createForm:function(f,i){var e=qq.toElement('<form method="post" enctype="multipart/form-data"></form>');var h=qq.obj2url(i,this._options.action);e.setAttribute("action",h);e.setAttribute("target",f.name);e.style.display="none";document.body.appendChild(e);return e}});qq.UploadHandlerXhr=function(b){qq.UploadHandlerAbstract.apply(this,arguments);this._files=[];this._xhrs=[];this._loaded=[]};qq.UploadHandlerXhr.isSupported=function(){var b=document.createElement("input");b.type="file";return("multiple" in b&&typeof File!="undefined"&&typeof(new XMLHttpRequest()).upload!="undefined")};qq.extend(qq.UploadHandlerXhr.prototype,qq.UploadHandlerAbstract.prototype);qq.extend(qq.UploadHandlerXhr.prototype,{add:function(b){if(!(b instanceof File)){throw new Error("Passed obj in not a File (in qq.UploadHandlerXhr)")}return this._files.push(b)-1},getName:function(c){var d=this._files[c];return d.fileName!=null?d.fileName:d.name},getSize:function(c){var d=this._files[c];return d.fileSize!=null?d.fileSize:d.size},getLoaded:function(b){return this._loaded[b]||0},_upload:function(k,m){var o=this._files[k],i=this.getName(k),p=this.getSize(k);this._loaded[k]=0;var n=this._xhrs[k]=new XMLHttpRequest();var j=this;n.upload.onprogress=function(a){if(a.lengthComputable){j._loaded[k]=a.loaded;j._options.onProgress(k,i,a.loaded,a.total)}};n.onreadystatechange=function(){if(n.readyState==4){j._onComplete(k,n)}};m=m||{};m.qqfile=i;var l=qq.obj2url(m,this._options.action);n.open("POST",l,true);n.setRequestHeader("X-Requested-With","XMLHttpRequest");n.setRequestHeader("X-File-Name",encodeURIComponent(i));n.setRequestHeader("Content-Type","application/octet-stream");n.send(o)},_onComplete:function(id,xhr){if(!this._files[id]){return}var name=this.getName(id);var size=this.getSize(id);this._options.onProgress(id,name,size,size);if(xhr.status==200){this.log("xhr - server response received");this.log("responseText = "+xhr.responseText);var response;try{response=eval("("+xhr.responseText+")")}catch(err){response={}}this._options.onComplete(id,name,response)}else{this._options.onComplete(id,name,{})}this._files[id]=null;this._xhrs[id]=null;this._dequeue(id)},_cancel:function(b){this._options.onCancel(b,this.getName(b));this._files[b]=null;if(this._xhrs[b]){this._xhrs[b].abort();this._xhrs[b]=null}}});(function(f){var e,i,h;f.extend({roundaboutShapes:{def:"lazySusan",lazySusan:function(j,d,k){return{x:Math.sin(j+d),y:Math.sin(j+3*Math.PI/2+d)/8*k,z:(Math.cos(j+d)+1)/2,scale:Math.sin(j+Math.PI/2+d)/2+0.5}}}});e={bearing:0,tilt:0,minZ:100,maxZ:280,minOpacity:0.4,maxOpacity:1,minScale:0.4,maxScale:1,duration:600,btnNext:null,btnNextCallback:function(){},btnPrev:null,btnPrevCallback:function(){},btnToggleAutoplay:null,btnStartAutoplay:null,btnStopAutoplay:null,easing:"swing",clickToFocus:true,clickToFocusCallback:function(){},focusBearing:0,shape:"lazySusan",debug:false,childSelector:"li",startingChild:null,reflect:false,floatComparisonThreshold:0.001,autoplay:false,autoplayDuration:1000,autoplayPauseOnHover:false,autoplayCallback:function(){},autoplayInitialDelay:0,enableDrag:false,dropDuration:600,dropEasing:"swing",dropAnimateTo:"nearest",dropCallback:function(){},dragAxis:"x",dragFactor:4,triggerFocusEvents:true,triggerBlurEvents:true,responsive:false};
i={autoplayInterval:null,autoplayIsRunning:false,autoplayStartTimeout:null,animating:false,childInFocus:-1,touchMoveStartPosition:null,stopAnimation:false,lastAnimationStep:false};h={init:function(j,d,c){var b,a=(new Date).getTime();j=typeof j==="object"?j:{};d=f.isFunction(d)?d:function(){};d=f.isFunction(j)?j:d;b=f.extend({},e,j,i);return this.each(function(){var l=f(this),q=l.children(b.childSelector).length,p=360/q,o=b.startingChild&&b.startingChild>q-1?q-1:b.startingChild,n=b.startingChild===null?b.bearing:360-o*p,m=l.css("position")!=="static"?l.css("position"):"relative";l.css({padding:0,position:m}).addClass("roundabout-holder").data("roundabout",f.extend({},b,{startingChild:o,bearing:n,oppositeOfFocusBearing:h.normalize.apply(null,[b.focusBearing-180]),dragBearing:n,period:p}));if(c){l.unbind(".roundabout").children(b.childSelector).unbind(".roundabout")}else{if(b.responsive){f(window).bind("resize",function(){h.stopAutoplay.apply(l);h.relayoutChildren.apply(l)})}}if(b.clickToFocus){l.children(b.childSelector).each(function(k){f(this).bind("click.roundabout",function(){var r=h.getPlacement.apply(l,[k]);if(!h.isInFocus.apply(l,[r])){h.stopAnimation.apply(f(this));if(!l.data("roundabout").animating){h.animateBearingToFocus.apply(l,[r,l.data("roundabout").clickToFocusCallback])}return false}})})}if(b.btnNext){f(b.btnNext).bind("click.roundabout",function(){if(!l.data("roundabout").animating){h.animateToNextChild.apply(l,[l.data("roundabout").btnNextCallback])}return false})}if(b.btnPrev){f(b.btnPrev).bind("click.roundabout",function(){h.animateToPreviousChild.apply(l,[l.data("roundabout").btnPrevCallback]);return false})}if(b.btnToggleAutoplay){f(b.btnToggleAutoplay).bind("click.roundabout",function(){h.toggleAutoplay.apply(l);return false})}if(b.btnStartAutoplay){f(b.btnStartAutoplay).bind("click.roundabout",function(){h.startAutoplay.apply(l);return false})}if(b.btnStopAutoplay){f(b.btnStopAutoplay).bind("click.roundabout",function(){h.stopAutoplay.apply(l);return false})}if(b.autoplayPauseOnHover){l.bind("mouseenter.roundabout.autoplay",function(){h.stopAutoplay.apply(l,[true])}).bind("mouseleave.roundabout.autoplay",function(){h.startAutoplay.apply(l)})}if(b.enableDrag){if(!f.isFunction(l.drag)){if(b.debug){alert("You do not have the drag plugin loaded.")}}else{if(!f.isFunction(l.drop)){if(b.debug){alert("You do not have the drop plugin loaded.")}}else{l.drag(function(k,t){var s=l.data("roundabout"),r=s.dragAxis.toLowerCase()==="x"?"deltaX":"deltaY";h.stopAnimation.apply(l);h.setBearing.apply(l,[s.dragBearing+t[r]/s.dragFactor])}).drop(function(k){var s=l.data("roundabout"),r=h.getAnimateToMethod(s.dropAnimateTo);h.allowAnimation.apply(l);h[r].apply(l,[s.dropDuration,s.dropEasing,s.dropCallback]);s.dragBearing=s.period*h.getNearestChild.apply(l)})}}l.each(function(){var k=f(this).get(0),t=f(this).data("roundabout"),s=t.dragAxis.toLowerCase()==="x"?"pageX":"pageY",r=h.getAnimateToMethod(t.dropAnimateTo);if(k.addEventListener){k.addEventListener("touchstart",function(u){t.touchMoveStartPosition=u.touches[0][s]},false);k.addEventListener("touchmove",function(u){var v=(u.touches[0][s]-t.touchMoveStartPosition)/t.dragFactor;u.preventDefault();h.stopAnimation.apply(f(this));h.setBearing.apply(f(this),[t.dragBearing+v])},false);k.addEventListener("touchend",function(u){u.preventDefault();h.allowAnimation.apply(f(this));r=h.getAnimateToMethod(t.dropAnimateTo);h[r].apply(f(this),[t.dropDuration,t.dropEasing,t.dropCallback]);t.dragBearing=t.period*h.getNearestChild.apply(f(this))},false)}})}h.initChildren.apply(l,[d,c])})},initChildren:function(a,k){var j=f(this),d=j.data("roundabout");a=a||function(){};j.children(d.childSelector).each(function(c){var o,n,m,l=h.getPlacement.apply(j,[c]);if(k&&f(this).data("roundabout")){o=f(this).data("roundabout").startWidth;n=f(this).data("roundabout").startHeight;m=f(this).data("roundabout").startFontSize}f(this).addClass("roundabout-moveable-item").css("position","absolute");f(this).data("roundabout",{startWidth:o||f(this).width(),startHeight:n||f(this).height(),startFontSize:m||parseInt(f(this).css("font-size"),10),degrees:l,backDegrees:h.normalize.apply(null,[l-180]),childNumber:c,currentScale:1,parent:j})});h.updateChildren.apply(j);if(d.autoplay){d.autoplayStartTimeout=setTimeout(function(){h.startAutoplay.apply(j)},d.autoplayInitialDelay)}j.trigger("ready");a.apply(j);return j},updateChildren:function(){return this.each(function(){var a=f(this),k=a.data("roundabout"),j=-1,d={bearing:k.bearing,tilt:k.tilt,stage:{width:Math.floor(f(this).width()*0.9),height:Math.floor(f(this).height()*0.9)},animating:k.animating,inFocus:k.childInFocus,focusBearingRadian:h.degToRad.apply(null,[k.focusBearing]),shape:f.roundaboutShapes[k.shape]||f.roundaboutShapes[f.roundaboutShapes.def]};d.midStage={width:d.stage.width/2,height:d.stage.height/2};d.nudge={width:d.midStage.width+d.stage.width*0.05,height:d.midStage.height+d.stage.height*0.05};d.zValues={min:k.minZ,max:k.maxZ,diff:k.maxZ-k.minZ};
d.opacity={min:k.minOpacity,max:k.maxOpacity,diff:k.maxOpacity-k.minOpacity};d.scale={min:k.minScale,max:k.maxScale,diff:k.maxScale-k.minScale};a.children(k.childSelector).each(function(b){if(h.updateChild.apply(a,[f(this),d,b,function(){f(this).trigger("ready")}])&&(!d.animating||k.lastAnimationStep)){j=b;f(this).addClass("roundabout-in-focus")}else{f(this).removeClass("roundabout-in-focus")}});if(j!==d.inFocus){if(k.triggerBlurEvents){a.children(k.childSelector).eq(d.inFocus).trigger("blur")}k.childInFocus=j;if(k.triggerFocusEvents&&j!==-1){a.children(k.childSelector).eq(j).trigger("focus")}}a.trigger("childrenUpdated")})},updateChild:function(t,s,r,q){var p,o=this,n=f(t),m=n.data("roundabout"),d=[],a=h.degToRad.apply(null,[360-m.degrees+s.bearing]);q=q||function(){};a=h.normalizeRad.apply(null,[a]);p=s.shape(a,s.focusBearingRadian,s.tilt);p.scale=p.scale>1?1:p.scale;p.adjustedScale=(s.scale.min+s.scale.diff*p.scale).toFixed(4);p.width=(p.adjustedScale*m.startWidth).toFixed(4);p.height=(p.adjustedScale*m.startHeight).toFixed(4);n.css({left:(p.x*s.midStage.width+s.nudge.width-p.width/2).toFixed(0)+"px",top:(p.y*s.midStage.height+s.nudge.height-p.height/2).toFixed(0)+"px",width:p.width+"px",height:p.height+"px",opacity:(s.opacity.min+s.opacity.diff*p.scale).toFixed(2),zIndex:Math.round(s.zValues.min+s.zValues.diff*p.z),fontSize:(p.adjustedScale*m.startFontSize).toFixed(1)+"px"});m.currentScale=p.adjustedScale;if(o.data("roundabout").debug){d.push('<div style="font-weight: normal; font-size: 10px; padding: 2px; width: '+n.css("width")+'; background-color: #ffc;">');d.push('<strong style="font-size: 12px; white-space: nowrap;">Child '+r+"</strong><br />");d.push("<strong>left:</strong> "+n.css("left")+"<br />");d.push("<strong>top:</strong> "+n.css("top")+"<br />");d.push("<strong>width:</strong> "+n.css("width")+"<br />");d.push("<strong>opacity:</strong> "+n.css("opacity")+"<br />");d.push("<strong>height:</strong> "+n.css("height")+"<br />");d.push("<strong>z-index:</strong> "+n.css("z-index")+"<br />");d.push("<strong>font-size:</strong> "+n.css("font-size")+"<br />");d.push("<strong>scale:</strong> "+n.data("roundabout").currentScale);d.push("</div>");n.html(d.join(""))}n.trigger("reposition");q.apply(o);return h.isInFocus.apply(o,[m.degrees])},setBearing:function(a,d){d=d||function(){};a=h.normalize.apply(null,[a]);this.each(function(){var n,m,l,k=f(this),j=k.data("roundabout"),b=j.bearing;j.bearing=a;k.trigger("bearingSet");h.updateChildren.apply(k);n=Math.abs(b-a);if(!j.animating||n>180){return}n=Math.abs(b-a);k.children(j.childSelector).each(function(p){var o;if(h.isChildBackDegreesBetween.apply(f(this),[a,b])){o=b>a?"Clockwise":"Counterclockwise";f(this).trigger("move"+o+"ThroughBack")}})});d.apply(this);return this},adjustBearing:function(a,d){d=d||function(){};if(a===0){return this}this.each(function(){h.setBearing.apply(f(this),[f(this).data("roundabout").bearing+a])});d.apply(this);return this},setTilt:function(a,d){d=d||function(){};this.each(function(){f(this).data("roundabout").tilt=a;h.updateChildren.apply(f(this))});d.apply(this);return this},adjustTilt:function(a,d){d=d||function(){};this.each(function(){h.setTilt.apply(f(this),[f(this).data("roundabout").tilt+a])});d.apply(this);return this},animateToBearing:function(a,m,l,k,j){var d=(new Date).getTime();j=j||function(){};if(f.isFunction(k)){j=k;k=null}else{if(f.isFunction(l)){j=l;l=null}else{if(f.isFunction(m)){j=m;m=null}}}this.each(function(){var r,q,p,c=f(this),b=c.data("roundabout"),t=!m?b.duration:m,s=l?l:b.easing||"swing";if(!k){k={timerStart:d,start:b.bearing,totalTime:t}}r=d-k.timerStart;if(b.stopAnimation){h.allowAnimation.apply(c);b.animating=false;return}if(r<t){if(!b.animating){c.trigger("animationStart")}b.animating=true;if(typeof f.easing.def==="string"){q=f.easing[s]||f.easing[f.easing.def];p=q(null,r,k.start,a-k.start,k.totalTime)}else{p=f.easing[s](r/k.totalTime,r,k.start,a-k.start,k.totalTime)}if(h.compareVersions.apply(null,[f().jquery,"1.7.2"])>=0&&!f.easing.easeOutBack){p=k.start+(a-k.start)*p}p=h.normalize.apply(null,[p]);b.dragBearing=p;h.setBearing.apply(c,[p,function(){setTimeout(function(){h.animateToBearing.apply(c,[a,t,s,k,j])},0)}])}else{b.lastAnimationStep=true;a=h.normalize.apply(null,[a]);h.setBearing.apply(c,[a,function(){c.trigger("animationEnd")}]);b.animating=false;b.lastAnimationStep=false;b.dragBearing=a;j.apply(c)}});return this},animateToNearbyChild:function(a,l){var k=a[0],j=a[1],d=a[2]||function(){};if(f.isFunction(j)){d=j;j=null}else{if(f.isFunction(k)){d=k;k=null}}return this.each(function(){var c,q,p=f(this),o=p.data("roundabout"),n=!o.reflect?o.bearing%360:o.bearing,m=p.children(o.childSelector).length;if(!o.animating){if(o.reflect&&l==="previous"||!o.reflect&&l==="next"){n=Math.abs(n)<o.floatComparisonThreshold?360:n;for(c=0;c<m;c+=1){q={lower:o.period*c,upper:o.period*(c+1)};q.upper=c===m-1?360:q.upper;if(n<=Math.ceil(q.upper)&&n>=Math.floor(q.lower)){if(m===2&&n===360){h.animateToDelta.apply(p,[-180,k,j,d])
}else{h.animateBearingToFocus.apply(p,[q.lower,k,j,d])}break}}}else{n=Math.abs(n)<o.floatComparisonThreshold||360-Math.abs(n)<o.floatComparisonThreshold?0:n;for(c=m-1;c>=0;c-=1){q={lower:o.period*c,upper:o.period*(c+1)};q.upper=c===m-1?360:q.upper;if(n>=Math.floor(q.lower)&&n<Math.ceil(q.upper)){if(m===2&&n===360){h.animateToDelta.apply(p,[180,k,j,d])}else{h.animateBearingToFocus.apply(p,[q.upper,k,j,d])}break}}}}})},animateToNearestChild:function(a,j,d){d=d||function(){};if(f.isFunction(j)){d=j;j=null}else{if(f.isFunction(a)){d=a;a=null}}return this.each(function(){var b=h.getNearestChild.apply(f(this));h.animateToChild.apply(f(this),[b,a,j,d])})},animateToChild:function(a,k,j,d){d=d||function(){};if(f.isFunction(j)){d=j;j=null}else{if(f.isFunction(k)){d=k;k=null}}return this.each(function(){var l,c=f(this),b=c.data("roundabout");if(b.childInFocus!==a&&!b.animating){l=c.children(b.childSelector).eq(a);h.animateBearingToFocus.apply(c,[l.data("roundabout").degrees,k,j,d])}})},animateToNextChild:function(j,d,k){return h.animateToNearbyChild.apply(this,[arguments,"next"])},animateToPreviousChild:function(j,d,k){return h.animateToNearbyChild.apply(this,[arguments,"previous"])},animateToDelta:function(a,k,j,d){d=d||function(){};if(f.isFunction(j)){d=j;j=null}else{if(f.isFunction(k)){d=k;k=null}}return this.each(function(){var b=f(this).data("roundabout").bearing+a;h.animateToBearing.apply(f(this),[b,k,j,d])})},animateBearingToFocus:function(a,k,j,d){d=d||function(){};if(f.isFunction(j)){d=j;j=null}else{if(f.isFunction(k)){d=k;k=null}}return this.each(function(){var b=f(this).data("roundabout").bearing-a;b=Math.abs(360-b)<Math.abs(b)?360-b:-b;b=b>180?-(360-b):b;if(b!==0){h.animateToDelta.apply(f(this),[b,k,j,d])}})},stopAnimation:function(){return this.each(function(){f(this).data("roundabout").stopAnimation=true})},allowAnimation:function(){return this.each(function(){f(this).data("roundabout").stopAnimation=false})},startAutoplay:function(a){return this.each(function(){var d=f(this),b=d.data("roundabout");a=a||b.autoplayCallback||function(){};clearInterval(b.autoplayInterval);b.autoplayInterval=setInterval(function(){h.animateToNextChild.apply(d,[a])},b.autoplayDuration);b.autoplayIsRunning=true;d.trigger("autoplayStart")})},stopAutoplay:function(a){return this.each(function(){clearInterval(f(this).data("roundabout").autoplayInterval);f(this).data("roundabout").autoplayInterval=null;f(this).data("roundabout").autoplayIsRunning=false;if(!a){f(this).unbind(".autoplay")}f(this).trigger("autoplayStop")})},toggleAutoplay:function(a){return this.each(function(){var d=f(this),b=d.data("roundabout");a=a||b.autoplayCallback||function(){};if(!h.isAutoplaying.apply(f(this))){h.startAutoplay.apply(f(this),[a])}else{h.stopAutoplay.apply(f(this),[a])}})},isAutoplaying:function(){return this.data("roundabout").autoplayIsRunning},changeAutoplayDuration:function(a){return this.each(function(){var d=f(this),b=d.data("roundabout");b.autoplayDuration=a;if(h.isAutoplaying.apply(d)){h.stopAutoplay.apply(d);setTimeout(function(){h.startAutoplay.apply(d)},10)}})},normalize:function(d){var c=d%360;return c<0?360+c:c},normalizeRad:function(b){while(b<0){b+=Math.PI*2}while(b>Math.PI*2){b-=Math.PI*2}return b},isChildBackDegreesBetween:function(a,k){var j=f(this).data("roundabout").backDegrees;if(a>k){return j>=k&&j<a}else{return j<k&&j>=a}},getAnimateToMethod:function(b){b=b.toLowerCase();if(b==="next"){return"animateToNextChild"}else{if(b==="previous"){return"animateToPreviousChild"}}return"animateToNearestChild"},relayoutChildren:function(){return this.each(function(){var a=f(this),d=f.extend({},a.data("roundabout"));d.startingChild=a.data("roundabout").childInFocus;h.init.apply(a,[d,null,true])})},getNearestChild:function(){var a=f(this),k=a.data("roundabout"),j=a.children(k.childSelector).length;if(!k.reflect){return(j-Math.round(k.bearing/k.period)%j)%j}else{return Math.round(k.bearing/k.period)%j}},degToRad:function(b){return h.normalize.apply(null,[b])*Math.PI/180},getPlacement:function(d){var c=this.data("roundabout");return !c.reflect?360-c.period*d:c.period*d},isInFocus:function(j){var d,m=this,l=m.data("roundabout"),k=h.normalize.apply(null,[l.bearing]);j=h.normalize.apply(null,[j]);d=Math.abs(k-j);return d<=l.floatComparisonThreshold||d>=360-l.floatComparisonThreshold},getChildInFocus:function(){var a=f(this).data("roundabout");return a.childInFocus>-1?a.childInFocus:false},compareVersions:function(k,j){var o,n=k.split(/\./i),m=j.split(/\./i),l=n.length>m.length?n.length:m.length;for(o=0;o<=l;o++){if(n[o]&&!m[o]&&parseInt(n[o],10)!==0){return 1}else{if(m[o]&&!n[o]&&parseInt(m[o],10)!==0){return -1}else{if(n[o]===m[o]){continue}}}if(n[o]&&m[o]){if(parseInt(n[o],10)>parseInt(m[o],10)){return 1}else{return -1}}}return 0}};f.fn.roundabout=function(a){if(h[a]){return h[a].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof a==="object"||f.isFunction(a)||!a){return h.init.apply(this,arguments)}else{f.error("Method "+a+" does not exist for jQuery.roundabout.")
}}}})(jQuery)
/*!
 * jQuery Smart Banner
 ...
 */
;!function(c){var d=function(b){this.origHtmlMargin=parseFloat(c("html").css("margin-top"));this.options=c.extend({},c.smartbanner.defaults,b);var f=navigator.standalone;if(this.options.force){this.type=this.options.force}else{if(navigator.userAgent.match(/iPad|iPhone|iPod/i)!=null){if(navigator.userAgent.match(/Safari/i)!=null&&(navigator.userAgent.match(/CriOS/i)!=null||window.Number(navigator.userAgent.substr(navigator.userAgent.indexOf("OS ")+3,3).replace("_","."))<6)){this.type="ios"}}else{if(navigator.userAgent.match(/Android/i)!=null){this.type="android"}}}if(!this.type||f||this.getCookie("sb-closed")||this.getCookie("sb-installed")){return}this.scale=this.options.scale=="auto"?c(window).width()/window.screen.width:this.options.scale;if(this.scale<1){this.scale=1}var a=c(this.type=="android"?'meta[name="google-play-app"]':'meta[name="apple-itunes-app"]');if(a.length==0){return}this.appId=/app-id=([^\s,]+)/.exec(a.attr("content"))[1];this.title=this.options.title?this.options.title:c("title").text().replace(/\s*[|\-·].*$/,"");this.author=this.options.author?this.options.author:(c('meta[name="author"]').length?c('meta[name="author"]').attr("content"):window.location.hostname);this.create();this.show();this.listen()};d.prototype={constructor:d,create:function(){var h,i=(this.options.url?this.options.url:(this.type=="android"?"market://details?id=":("https://itunes.apple.com/"+this.options.appStoreLanguage+"/app/id"))+this.appId),a=this.options.price?this.options.price+" - "+(this.type=="android"?this.options.inGooglePlay:this.options.inAppStore):"",b=this.options.iconGloss===null?(this.type=="ios"):this.options.iconGloss;c("body").append('<div id="smartbanner" class="'+this.type+'"><div class="sb-container"><a href="#" class="sb-close">&times;</a><span class="sb-icon"></span><div class="sb-info"><strong>'+this.title+"</strong><span>"+this.author+"</span><span>"+a+'</span></div><a href="'+i+'" class="sb-button"><span>'+this.options.button+"</span></a></div></div>");if(this.options.icon){h=this.options.icon}else{if(c('link[rel="apple-touch-icon-precomposed"]').length>0){h=c('link[rel="apple-touch-icon-precomposed"]').attr("href");if(this.options.iconGloss===null){b=false}}else{if(c('link[rel="apple-touch-icon"]').length>0){h=c('link[rel="apple-touch-icon"]').attr("href")}}}if(h){c("#smartbanner .sb-icon").css("background-image","url("+h+")");if(b){c("#smartbanner .sb-icon").addClass("gloss")}}else{c("#smartbanner").addClass("no-icon")}this.bannerHeight=c("#smartbanner").outerHeight()+2;if(this.scale>1){c("#smartbanner").css("top",parseFloat(c("#smartbanner").css("top"))*this.scale).css("height",parseFloat(c("#smartbanner").css("height"))*this.scale);c("#smartbanner .sb-container").css("-webkit-transform","scale("+this.scale+")").css("-msie-transform","scale("+this.scale+")").css("-moz-transform","scale("+this.scale+")").css("width",c(window).width()/this.scale)}},listen:function(){c("#smartbanner .sb-close").on("click",c.proxy(this.close,this));c("#smartbanner .sb-button").on("click",c.proxy(this.install,this))},show:function(a){c("#smartbanner").stop().animate({top:0},this.options.speedIn).addClass("shown");c("html").animate({marginTop:this.origHtmlMargin+(this.bannerHeight*this.scale)},this.options.speedIn,"swing",a)},hide:function(a){c("#smartbanner").stop().animate({top:-1*this.bannerHeight*this.scale},this.options.speedOut).removeClass("shown");c("html").animate({marginTop:this.origHtmlMargin},this.options.speedOut,"swing",a)},close:function(a){a.preventDefault();this.hide();this.setCookie("sb-closed","true",this.options.daysHidden)},install:function(a){this.hide();this.setCookie("sb-installed","true",this.options.daysReminder)},setCookie:function(i,b,h){var a=new Date();a.setDate(a.getDate()+h);b=escape(b)+((h==null)?"":"; expires="+a.toUTCString());document.cookie=i+"="+b+"; path=/;"},getCookie:function(i){var h,j,a,b=document.cookie.split(";");for(h=0;h<b.length;h++){j=b[h].substr(0,b[h].indexOf("="));a=b[h].substr(b[h].indexOf("=")+1);j=j.replace(/^\s+|\s+$/g,"");if(j==i){return unescape(a)}}return null},switchType:function(){var a=this;this.hide(function(){a.type=a.type=="android"?"ios":"android";var b=c(a.type=="android"?'meta[name="google-play-app"]':'meta[name="apple-itunes-app"]').attr("content");a.appId=/app-id=([^\s,]+)/.exec(b)[1];c("#smartbanner").detach();a.create();a.show()})}};c.smartbanner=function(h){var a=c(window),b=a.data("typeahead"),i=typeof h=="object"&&h;if(!b){a.data("typeahead",(b=new d(i)))}if(typeof h=="string"){b[h]()}};c.smartbanner.defaults={title:null,author:null,price:"FREE",appStoreLanguage:"us",inAppStore:"On the App Store",inGooglePlay:"In Google Play",icon:null,iconGloss:null,button:"VIEW",url:null,scale:"auto",speedIn:300,speedOut:400,daysHidden:15,daysReminder:90,force:null};c.smartbanner.Constructor=d
}(window.jQuery);var _gaq=_gaq||[];_gaq.push(["_setAccount","UA-33888939-3"]);_gaq.push(["_trackPageview"]);(function(){var c=document.createElement("script");c.type="text/javascript";c.async=true;c.src=("https:"==document.location.protocol?"https://ssl":"http://www")+".google-analytics.com/ga.js";var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(c,d)})();